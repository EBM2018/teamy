define({ "api": [
  ...
  {
    "type": "post",
    "url": "/groups/:GroupId/seances/new",
    "title": "Create new seance inside a group",
    "name": "CreateSeance",
    "group": "Groups",
    "description": "<p>Create a new Seance with the body, and saves it to the group by id</p>",
    "parameter": {
      "examples": [
        {
          "title": "Request-example:",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:4000/api/groups/:GroupId/seances/new"
      }
    ]
  },
  {
